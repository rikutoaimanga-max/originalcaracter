...
export const categories: Category[] = [
    ...
    },
    {
        ...
        items: [
            ...
            // 追加分：その他・特殊
            { id: "fur_hat", label: "ファーハット", value: "fur hat", imageSrc: "https://placehold.co/400x400/png?text=FurHat" },
            { id: "nightcap", label: "ナイトキャップ", value: "nightcap", imageSrc: "https://placehold.co/400x400/png?text=Nightcap" },
            { id: "picture_hat", label: "ピクチャーハット", value: "picture hat", imageSrc: "https://placehold.co/400x400/png?text=Picture" },
            { id: "cavalier_hat", label: "カヴァリエハット", value: "cavalier hat", imageSrc: "https://placehold.co/400x400/png?text=Cavalier" },
            { id: "mini_top_hat", label: "ミニシルクハット", value: "mini top hat", imageSrc: "https://placehold.co/400x400/png?text=MiniTop" },
            { id: "female_service_cap", label: "女性用制帽", value: "female service cap", imageSrc: "https://placehold.co/400x400/png?text=ServiceCap" },
            { id: "garrison_cap", label: "ギャリソンキャップ", value: "garrison cap", imageSrc: "https://placehold.co/400x400/png?text=Garrison" },
            { id: "field_cap", label: "フィールドキャップ", value: "field cap", imageSrc: "https://placehold.co/400x400/png?text=FieldCap" },
            { id: "shako_cap", label: "シャコー帽", value: "shako cap", imageSrc: "https://placehold.co/400x400/png?text=Shako" },
            { id: "mitre", label: "ミトラ", value: "mitre", imageSrc: "https://placehold.co/400x400/png?text=Mitre" },
            { id: "bicorne", label: "二角帽", value: "bicorne", imageSrc: "https://placehold.co/400x400/png?text=Bicorne" },
            // 文化・民族
            { id: "tokin_hat", label: "頭巾", value: "tokin hat", imageSrc: "https://placehold.co/400x400/png?text=Tokin" },
            { id: "tate_eboshi", label: "立烏帽子", value: "tate eboshi", imageSrc: "https://placehold.co/400x400/png?text=Eboshi" },
            { id: "qingdai_guanmao", label: "清代官帽", value: "qingdai guanmao", imageSrc: "https://placehold.co/400x400/png?text=Guanmao" },
            { id: "rice_hat", label: "笠", value: "rice hat", imageSrc: "https://placehold.co/400x400/png?text=RiceHat" },
            { id: "ajirogasa", label: "網代笠", value: "ajirogasa", imageSrc: "https://placehold.co/400x400/png?text=Ajirogasa" },
            { id: "ichimegasa", label: "市女笠", value: "ichimegasa", imageSrc: "https://placehold.co/400x400/png?text=Ichimegasa" },
            { id: "sandogasa", label: "三度笠", value: "sandogasa", imageSrc: "https://placehold.co/400x400/png?text=Sandogasa" },
            { id: "keffiyeh", label: "ケフィーヤ", value: "keffiyeh", imageSrc: "https://placehold.co/400x400/png?text=Keffiyeh" },
            { id: "hijab", label: "ヒジャブ", value: "hijab", imageSrc: "https://placehold.co/400x400/png?text=Hijab" },
            { id: "sombrero", label: "ソンブレロ", value: "sombrero", imageSrc: "https://placehold.co/400x400/png?text=Sombrero" },
            // イベント・ファンタジー
            { id: "party_hat", label: "パーティーハット", value: "party hat", imageSrc: "https://placehold.co/400x400/png?text=Party" },
            { id: "santa_hat", label: "サンタ帽", value: "santa hat", imageSrc: "https://placehold.co/400x400/png?text=Santa" },
            { id: "pumpkin_hat", label: "カボチャ帽子", value: "pumpkin hat", imageSrc: "https://placehold.co/400x400/png?text=Pumpkin" },
            { id: "wizard_hat", label: "魔法使い帽子", value: "wizard hat", imageSrc: "https://placehold.co/400x400/png?text=Wizard" },
            // 動物・ヘルメット・その他
            { id: "bear_hat", label: "クマ帽子", value: "bear hat", imageSrc: "https://placehold.co/400x400/png?text=Bear" },
            { id: "dog_hat", label: "犬帽子", value: "dog hat", imageSrc: "https://placehold.co/400x400/png?text=Dog" },
            { id: "fox_hat", label: "キツネ帽子", value: "fox hat", imageSrc: "https://placehold.co/400x400/png?text=Fox" },
            { id: "penguin_hat", label: "ペンギン帽子", value: "penguin hat", imageSrc: "https://placehold.co/400x400/png?text=Penguin" },
            { id: "rabbit_hat", label: "ウサギ帽子", value: "rabbit hat", imageSrc: "https://placehold.co/400x400/png?text=Rabbit" },
            { id: "bicycle_helmet", label: "自転車メット", value: "bicycle helmet", imageSrc: "https://placehold.co/400x400/png?text=BikeHelm" },
            { id: "football_helmet", label: "アメフトメット", value: "football helmet", imageSrc: "https://placehold.co/400x400/png?text=FootHelm" },
            { id: "pilot_helmet", label: "パイロットメット", value: "pilot helmet", imageSrc: "https://placehold.co/400x400/png?text=Pilot" },
            { id: "astronaut_helmet", label: "宇宙飛行士", value: "astronaut helmet", imageSrc: "https://placehold.co/400x400/png?text=Astro" },
            { id: "hard_hat", label: "ヘルメット(作業)", value: "hard hat", imageSrc: "https://placehold.co/400x400/png?text=HardHat" },
            { id: "horned_helmet", label: "角付きメット", value: "horned helmet", imageSrc: "https://placehold.co/400x400/png?text=Horned" },
            { id: "headband", label: "ヘッドバンド", value: "headband", imageSrc: "https://placehold.co/400x400/png?text=Headband" },
            { id: "hachimaki", label: "鉢巻", value: "hachimaki", imageSrc: "https://placehold.co/400x400/png?text=Hachimaki" },
            { id: "headscarf", label: "ヘッドスカーフ", value: "headscarf", imageSrc: "https://placehold.co/400x400/png?text=Headscarf" },
            { id: "bandana", label: "バンダナ", value: "bandana", imageSrc: "https://placehold.co/400x400/png?text=Bandana" },
            { id: "diadem", label: "ディアデム", value: "diadem", imageSrc: "https://placehold.co/400x400/png?text=Diadem" },
            { id: "fascinator", label: "ファシネーター", value: "fascinator", imageSrc: "https://placehold.co/400x400/png?text=Fascinator" },
        ],
    },
];
