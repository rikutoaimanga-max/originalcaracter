...
export const categories: Category[] = [
    ...
    },
    {
        ...
        items: [
            randomOption,
            // カジュアル
            { id: "baseball_cap", label: "野球帽", value: "baseball cap", imageSrc: "/images/hat/baseball_cap.png" },
            { id: "beanie", label: "ビーニー", value: "beanie", imageSrc: "/images/hat/beanie.png" },
            { id: "bucket_hat", label: "バケットハット", value: "bucket hat", imageSrc: "/images/hat/bucket_hat.png" },
            { id: "flat_cap", label: "ハンチング", value: "flat cap", imageSrc: "/images/hat/flat_cap.png" },
            { id: "sun_hat", label: "つば広帽", value: "sun hat", imageSrc: "/images/hat/sun_hat.png" },
            { id: "straw_hat", label: "麦わら帽子", value: "straw hat", imageSrc: "/images/hat/straw_hat.png" },
            { id: "beret", label: "ベレー帽", value: "beret", imageSrc: "/images/hat/beret.png" },
            { id: "boater_hat", label: "カンカン帽", value: "boater hat", imageSrc: "/images/hat/boater_hat.png" },
            { id: "bowler_hat", label: "山高帽", value: "bowler hat", imageSrc: "/images/hat/bowler_hat.png" },
            { id: "bonnet", label: "ボンネット", value: "bonnet", imageSrc: "/images/hat/bonnet.png" },
            { id: "cabbie_hat", label: "キャビーハット", value: "cabbie hat", imageSrc: "/images/hat/cabbie_hat.png" },
            { id: "deerstalker", label: "鹿撃ち帽", value: "deerstalker", imageSrc: "/images/hat/deerstalker.png" },
            { id: "fedora", label: "中折れ帽", value: "fedora", imageSrc: "/images/hat/fedora.png" },
            { id: "top_hat", label: "シルクハット", value: "top hat", imageSrc: "/images/hat/top_hat.png" },
            // 職業・イベント・その他
            { id: "military_hat", label: "軍帽", value: "military hat", imageSrc: "/images/hat/military_hat.png" },
            { id: "police_hat", label: "警官帽", value: "police hat", imageSrc: "/images/hat/police_hat.png" },
            { id: "nurse_cap", label: "ナースキャップ", value: "nurse cap", imageSrc: "/images/hat/nurse_cap.png" },
            { id: "chef_hat", label: "コック帽", value: "chef hat", imageSrc: "/images/hat/chef_hat.png" },
            { id: "school_hat", label: "学生帽", value: "school hat", imageSrc: "/images/hat/school_hat.png" },
            { id: "mortarboard", label: "角帽", value: "mortarboard", imageSrc: "/images/hat/mortarboard.png" },
            { id: "sailor_hat", label: "セーラーハット", value: "sailor hat", imageSrc: "/images/hat/sailor_hat.png" },
            { id: "cowboy_hat", label: "カウボーイ", value: "cowboy hat", imageSrc: "/images/hat/cowboy_hat.png" },
            { id: "pirate_hat", label: "海賊帽", value: "pirate hat", imageSrc: "/images/hat/pirate_hat.png" },
            { id: "witch_hat", label: "魔女の帽子", value: "witch hat", imageSrc: "/images/hat/witch_hat.png" },
            { id: "cat_hat", label: "猫耳帽子", value: "cat hat", imageSrc: "/images/hat/cat_hat.png" },
            { id: "helmet", label: "ヘルメット", value: "helmet", imageSrc: "/images/hat/helmet.png" },
            { id: "crown", label: "王冠", value: "crown", imageSrc: "/images/hat/crown.png" },
            ...
            { id: "papakha", label: "パパーハ", value: "papakha", imageSrc: "/images/hat/papakha.png" },
            { id: "ushanka", label: "ウシャンカ", value: "ushanka", imageSrc: "/images/hat/ushanka.png" },
            { id: "turban", label: "ターバン", value: "turban", imageSrc: "/images/hat/turban.png" },
            { id: "fox_mask", label: "狐面", value: "fox mask on head", imageSrc: "/images/hat/fox_mask.png" },
            // 追加分：その他・特殊
            { id: "fur_hat", label: "ファーハット", value: "fur hat", imageSrc: "/images/hat/fur_hat.png" },
            { id: "nightcap", label: "ナイトキャップ", value: "nightcap", imageSrc: "/images/hat/nightcap.png" },
            { id: "picture_hat", label: "ピクチャーハット", value: "picture hat", imageSrc: "/images/hat/picture_hat.png" },
            { id: "cavalier_hat", label: "カヴァリエハット", value: "cavalier hat", imageSrc: "/images/hat/cavalier_hat.png" },
            { id: "mini_top_hat", label: "ミニシルクハット", value: "mini top hat", imageSrc: "/images/hat/mini_top_hat.png" },
            { id: "female_service_cap", label: "女性用制帽", value: "female service cap", imageSrc: "/images/hat/female_service_cap.png" },
            { id: "garrison_cap", label: "ギャリソンキャップ", value: "garrison cap", imageSrc: "/images/hat/garrison_cap.png" },
            { id: "field_cap", label: "フィールドキャップ", value: "field cap", imageSrc: "/images/hat/field_cap.png" },
            { id: "shako_cap", label: "シャコー帽", value: "shako cap", imageSrc: "/images/hat/shako_cap.png" },
            { id: "mitre", label: "ミトラ", value: "mitre", imageSrc: "/images/hat/mitre.png" },
            { id: "bicorne", label: "二角帽", value: "bicorne", imageSrc: "/images/hat/bicorne.png" },
            // 文化・民族
            { id: "tokin_hat", label: "頭巾", value: "tokin hat", imageSrc: "/images/hat/tokin_hat.png" },
            { id: "tate_eboshi", label: "立烏帽子", value: "tate eboshi", imageSrc: "/images/hat/tate_eboshi.png" },
            { id: "qingdai_guanmao", label: "清代官帽", value: "qingdai guanmao", imageSrc: "/images/hat/qingdai_guanmao.png" },
            { id: "rice_hat", label: "笠", value: "rice hat", imageSrc: "/images/hat/rice_hat.png" },
            { id: "ajirogasa", label: "網代笠", value: "ajirogasa", imageSrc: "/images/hat/ajirogasa.png" },
            { id: "ichimegasa", label: "市女笠", value: "ichimegasa", imageSrc: "/images/hat/ichimegasa.png" },
            { id: "sandogasa", label: "三度笠", value: "sandogasa", imageSrc: "/images/hat/sandogasa.png" },
            { id: "keffiyeh", label: "ケフィーヤ", value: "keffiyeh", imageSrc: "/images/hat/keffiyeh.png" },
            { id: "hijab", label: "ヒジャブ", value: "hijab", imageSrc: "/images/hat/hijab.png" },
            { id: "sombrero", label: "ソンブレロ", value: "sombrero", imageSrc: "/images/hat/sombrero.png" },
            // イベント・ファンタジー
            ...
            // 動物・ヘルメット・その他
            { id: "bear_hat", label: "クマ帽子", value: "bear hat", imageSrc: "/images/hat/bear_hat.png" },
            { id: "dog_hat", label: "犬帽子", value: "dog hat", imageSrc: "/images/hat/dog_hat.png" },
            { id: "fox_hat", label: "キツネ帽子", value: "fox hat", imageSrc: "/images/hat/fox_hat.png" },
            { id: "penguin_hat", label: "ペンギン帽子", value: "penguin hat", imageSrc: "/images/hat/penguin_hat.png" },
            { id: "rabbit_hat", label: "ウサギ帽子", value: "rabbit hat", imageSrc: "/images/hat/rabbit_hat.png" },
            { id: "bicycle_helmet", label: "自転車メット", value: "bicycle helmet", imageSrc: "/images/hat/bicycle_helmet.png" },
            { id: "football_helmet", label: "アメフトメット", value: "football helmet", imageSrc: "/images/hat/football_helmet.png" },
            { id: "pilot_helmet", label: "パイロットメット", value: "pilot helmet", imageSrc: "/images/hat/pilot_helmet.png" },
            { id: "astronaut_helmet", label: "宇宙飛行士", value: "astronaut helmet", imageSrc: "/images/hat/astronaut_helmet.png" },
            { id: "hard_hat", label: "ヘルメット(作業)", value: "hard hat", imageSrc: "/images/hat/hard_hat.png" },
            { id: "horned_helmet", label: "角付きメット", value: "horned helmet", imageSrc: "/images/hat/horned_helmet.png" },
            ...
            { id: "headscarf", label: "ヘッドスカーフ", value: "headscarf", imageSrc: "/images/hat/headscarf.png" },
            { id: "bandana", label: "バンダナ", value: "bandana", imageSrc: "/images/hat/bandana.png" },
            { id: "diadem", label: "ディアデム", value: "diadem", imageSrc: "/images/hat/diadem.png" },
            { id: "fascinator", label: "ファシネーター", value: "fascinator", imageSrc: "/images/hat/fascinator.png" },
        ],
    },
];
